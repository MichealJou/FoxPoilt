...
export default defineConfig({
  resolve: {
    alias: [
      { find: '@foxpilot/contracts', replacement: fileURLToPath(new URL('./packages/contracts/src', import.meta.url)) },
      { find: '@foxpilot/runtime', replacement: fileURLToPath(new URL('./packages/runtime/src', import.meta.url)) },
