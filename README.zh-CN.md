...
- macOS / Linux
  - 一键安装脚本
  - 命令：`curl -fsSL https://raw.githubusercontent.com/MichealJou/FoxPoilt/main/install.sh | sh`
- Windows
  - 一键安装脚本
  - 命令：`irm https://raw.githubusercontent.com/MichealJou/FoxPoilt/main/install.ps1 | iex`
- 所有平台
  - `npm` 全局安装
...
- 根目录 `install.sh` / `install.ps1` 是对正式安装脚本的公开一键入口
