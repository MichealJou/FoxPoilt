...
type _BaseContextLanguage = Assert<
  CliRuntimeContext extends { interfaceLanguage: InterfaceLanguage } ? true : false
>
type _InitContextLanguage = Assert<
  InitCommandContext extends { interfaceLanguage: InterfaceLanguage } ? true : false
>
...
>
type _TaskListContextLanguage = Assert<
  TaskListContext extends { interfaceLanguage: InterfaceLanguage } ? true : false
>
type _TaskShowContextLanguage = Assert<
  TaskShowContext extends { interfaceLanguage: InterfaceLanguage } ? true : false
>
...
type _ConfigContextDependencies = Assert<
  ConfigSetLanguageContext extends { dependencies?: Partial<ConfigSetLanguageDependencies> }
    ? true
    : false
>
...
type _TaskUpdateStatusContextDependencies = Assert<
  TaskUpdateStatusContext extends { dependencies?: Partial<TaskUpdateStatusDependencies> }
    ? true
    : false
>
