...
describe('update runner', () => {
  it('builds the npm update command', async () => {
    const { runNpmUpdate } = await import('@foxpilot/infra/install/update-runner.js')
  ...
  it('builds the brew update command', async () => {
    const { runBrewUpdate } = await import('@foxpilot/infra/install/update-runner.js')
  ...
  it('builds the unix release update command', async () => {
    const { runReleaseUpdate } = await import('@foxpilot/infra/install/update-runner.js')
